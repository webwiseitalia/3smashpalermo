      ...
      <header className="bg-[#3451a1] py-8 md:py-12">
        <div className="px-6 md:px-12 lg:px-20 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[#faf3e3] text-3xl md:text-4xl font-display font-bold uppercase">Privacy Policy</h1>
              <p className="text-[#faf3e3]/60 text-sm">Informativa sul trattamento dei dati personali</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-[900px] mx-auto">
          <div className="bg-[#1a1a1a] rounded-2xl p-8 md:p-12 border border-[#faf3e3]/10">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-[#faf3e3] text-lg font-semibold mb-3">2.1 Dati forniti volontariamente dall'utente</h3>
              <p className="text-[#faf3e3]/70 mb-4">
              ...
              <div className="bg-[#faf3e3]/5 border border-[#faf3e3]/10 p-4 rounded-lg mb-6">
                <p className="text-[#faf3e3]/80 text-sm">
                  <strong className="text-[#faf3e3]">Finalità:</strong> I dati vengono raccolti esclusivamente per:
                </p>
                <ul className="text-[#faf3e3]/70 text-sm mt-2 space-y-1">
              ...
              <h3 className="text-[#faf3e3] text-lg font-semibold mb-3">2.2 Base giuridica del trattamento</h3>
              <p className="text-[#faf3e3]/70">
                Il trattamento è basato sul <strong className="text-[#faf3e3]">consenso esplicito</strong> dell'interessato (Art. 6, par. 1, lett. a del GDPR), fornito attraverso l'invio del modulo di contatto, e sulla <strong className="text-[#faf3e3]">esecuzione di misure precontrattuali</strong> (Art. 6, par. 1, lett. b del GDPR).
              </p>
            </section>
            ...
            {/* Footer nota */}
            <div className="border-t border-[#faf3e3]/10 pt-8 mt-10">
              <p className="text-[#faf3e3]/40 text-xs text-center">
