    ...
    <div className="bg-[#0a0a0a] min-h-screen">
      ...
      <header className="bg-[#3451a1] py-8 md:py-12">
        <div className="px-6 md:px-12 lg:px-20 max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[#faf3e3] text-3xl md:text-4xl font-display font-bold uppercase">Cookie Policy</h1>
              <p className="text-[#faf3e3]/60 text-sm">Informativa sull'utilizzo dei cookie</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="px-6 md:px-12 lg:px-20 py-12 md:py-16">
        <div className="max-w-[900px] mx-auto">
          <div className="bg-[#1a1a1a] rounded-2xl p-8 md:p-12 border border-[#faf3e3]/10">
            <p className="text-[#faf3e3]/50 text-sm mb-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#faf3e3]/70 text-sm">
                    Questo sito web utilizza <strong className="text-[#faf3e3]">solo cookie tecnici</strong> necessari al funzionamento. <strong className="text-[#faf3e3]">Non utilizziamo cookie di profilazione, tracciamento o analisi</strong>. La tua privacy è protetta e non serve il tuo consenso per la navigazione.
                  </p>
                </div>
              </div>
            </div>
            ...
            <section className="mb-10">
              <h2 className="text-[#faf3e3] text-xl md:text-2xl font-display font-bold uppercase mb-4">
            ...
            <section className="mb-10">
              ...
              <h3 className="text-[#faf3e3] text-lg font-semibold mb-3">2.1 Cookie Tecnici</h3>
              ...
              <div className="bg-[#faf3e3]/5 border border-[#faf3e3]/10 p-4 rounded-lg mb-6">
                <p className="text-[#faf3e3] font-semibold text-sm mb-2">Cookie tecnici utilizzati su questo sito:</p>
                <ul className="text-[#faf3e3]/70 text-sm space-y-1">
                  <li>• Cookie di navigazione e di sessione</li>
                  <li>• Cookie per memorizzare le preferenze dell'interfaccia</li>
                </ul>
                <p className="text-[#faf3e3]/50 text-xs mt-3">
                  Secondo la normativa vigente, i cookie tecnici non richiedono il consenso dell'utente.
                </p>
              </div>

              <h3 className="text-[#faf3e3] text-lg font-semibold mb-3">2.2 Cookie Analitici</h3>
              ...
              <h3 className="text-[#faf3e3] text-lg font-semibold mb-3">2.3 Cookie di Profilazione</h3>
              <div className="flex items-center gap-3 bg-red-900/10 border border-red-500/20 p-4 rounded-lg mb-6">
                <span className="text-red-400 font-semibold text-sm">NON UTILIZZATI</span>
                <p className="text-[#faf3e3]/70 text-sm">
              ...
              <h3 className="text-[#faf3e3] text-lg font-semibold mb-3">2.4 Cookie di Terze Parti</h3>
            ...
            <section className="mb-10">
              ...
              <p className="text-[#faf3e3]/70 mb-6">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#faf3e3]/20">
                      <th className="text-left text-[#faf3e3] py-3 px-4">Nome Cookie</th>
                      <th className="text-left text-[#faf3e3] py-3 px-4">Tipologia</th>
                      <th className="text-left text-[#faf3e3] py-3 px-4">Finalità</th>
                      <th className="text-left text-[#faf3e3] py-3 px-4">Durata</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <div className="bg-[#faf3e3]/5 border border-[#faf3e3]/10 p-4 rounded-lg mt-6">
                <p className="text-[#faf3e3]/70 text-sm">
                  <strong className="text-[#faf3e3]">Nota importante:</strong> I cookie tecnici come "{siteData.cookieKey}" sono essenziali per il funzionamento del sito e non richiedono il consenso dell'utente ai sensi del Provvedimento del Garante Privacy n. 229/2014 e del GDPR.
                </p>
              </div>
            </section>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
            <Link
              to="/"
              className="text-center border-2 border-[#faf3e3]/30 text-[#faf3e3] px-8 py-4 uppercase tracking-wider text-sm font-semibold hover:bg-[#faf3e3] hover:text-[#0a0a0a] transition-all"
            >
              Torna alla Home
            </Link>
            <Link
      ...
      {/* Footer */}
      <footer className="py-12 bg-[#0a0a0a] border-t border-[#faf3e3]/10">
        <div className="px-6 md:px-12 lg:px-20 max-w-[1600px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <p className="text-[#faf3e3]/30 text-sm">
              © {new Date().getFullYear()} {siteData.name}. Tutti i diritti riservati.
            </p>
            <div className="flex gap-6">
              <Link to="/privacy-policy" onClick={() => window.scrollTo(0, 0)} className="text-[#faf3e3]/50 hover:text-[#faf3e3] text-sm">Privacy Policy</Link>
              <Link to="/cookie-policy" onClick={() => window.scrollTo(0, 0)} className="text-[#faf3e3]/50 hover:text-[#faf3e3] text-sm">Cookie Policy</Link>
            </div>
          </div>
        </div>
      </footer>
